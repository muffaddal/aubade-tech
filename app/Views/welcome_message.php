...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Welcome to AUBADE Tech Assignment</h1>

        <span>Powered by CodeIgnitor<?= CodeIgniter\CodeIgniter::CI_VERSION ?></span>
...
<section>
    <b>Here is the List of Categories and SubCategories: </b>
    ...
    <?php foreach($data as $key => $value){ ?>
        ...
        <td><?php echo $value->s_cat_name; ?></td>
    ...
    <a href="/form">Create Categories From here</a>
